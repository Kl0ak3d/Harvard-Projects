...
int compute_score(string word)
{
    ...
    for (int i = 0; i < strlen(word); i++)
    {
        ...
        if (isupper(word[i]))
        {
            //  find the words from capital_letters array according to ASCII
            //  assign points to temp_Points array accourding to the index
        ...
        {
            //  find the words from small_letters array according to ASCII
            //  assign points to temp_Points array accourding to the index
            //  calculate the total score
